...
export const movieSchema = z.object({
  ...
  country: z
    .string()
    .trim()
    .max(100, { message: 'Země původu může mít maximálně 100 znaků' })
    .optional()
    .or(z.literal('')),
  slogan: z
    .string()
    .trim()
    .max(200, { message: 'Slogan může mít maximálně 200 znaků' })
    .optional()
    .or(z.literal('')),
  screenplay: z
    .string()
    .trim()
    .max(200, { message: 'Scénář může mít maximálně 200 znaků' })
    .optional()
    .or(z.literal('')),
  producer: z
    .string()
    .trim()
    .max(200, { message: 'Produkce může mít maximálně 200 znaků' })
    .optional()
    .or(z.literal('')),
  cinematography: z
    .string()
    .trim()
    .max(100, { message: 'Kamera může mít maximálně 100 znaků' })
    .optional()
    .or(z.literal('')),
  music: z
    .string()
    .trim()
    .max(100, { message: 'Hudba může mít maximálně 100 znaků' })
    .optional()
    .or(z.literal('')),
  budget: z
    .string()
    .trim()
    .max(50, { message: 'Rozpočet může mít maximálně 50 znaků' })
    .optional()
    .or(z.literal('')),
  box_office: z
    .string()
    .trim()
    .max(50, { message: 'Tržby mohou mít maximálně 50 znaků' })
    .optional()
    .or(z.literal('')),
  age_rating: z
    .string()
    .trim()
    .max(20, { message: 'Přístupnost může mít maximálně 20 znaků' })
    .optional()
    .or(z.literal('')),
  duration: z
    .string()
    .trim()
    .max(30, { message: 'Délka může mít maximálně 30 znaků' })
    .optional()
    .or(z.literal(''))
});

// Seznam podporovaných žánrů v aplikaci CineVault
export const GENRES = [
  'Sci-Fi',
  'Action',
  'Drama',
